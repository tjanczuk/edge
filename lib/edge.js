...
function determineVersion() {
	if (process.versions.node.match(/^0\.8\./)) {
		return '0.8.22';
	}
	else if (process.versions.node.match(/^0\.10\./)) {
		return '0.10.0';
	}
	else {
...
exports.func = function(options) {
	...
	return function (data, callbackOrSync) {
		return edge.callClrFunc(appId, data, callbackOrSync);
	};
}
