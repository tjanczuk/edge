...
class Mono < Formula
  ...
  def install
    ...
    system "curl https://raw.githubusercontent.com/tjanczuk/edge/mono/tools/Microsoft.Portable.Common.targets > ./mcs/tools/xbuild/targets/Microsoft.Portable.Common.targets"
